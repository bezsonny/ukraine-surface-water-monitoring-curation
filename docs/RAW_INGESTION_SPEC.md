...
Controle_Date is normalized deterministically to ISO 8601 YYYY-MM-DD. The parser explicitly accepts both YYYY-MM-DD and the historical source format DD.MM.YYYY; any other date representation terminates the pipeline.
